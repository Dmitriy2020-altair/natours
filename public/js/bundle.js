...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGltYS1rdXptaW4tMjAyMyIsImEiOiJjbGJwMzYzcWswMnVoM25vMGZiOXo5aGh6In0.ERxegm9mIp2J3qG5FYT2vw';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " changed and saved"));
            }
            _context.next = 12;
            break;
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            console.log('ERROR 2', _context.t0);
            (0, _alerts.showAlert)('error', _context.t0.response.data.message);
          case 12:
          case "end":
            return _context.stop();
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
/* eslint-disable */
var stripe = Stripe('pk_test_51MJLYtG07WAQZ9ygUoofDXs2hRQ7ImEiLg8mtJHXQCw5wPFHRraYfCV8HeKp8J1IUevrbEkL7HwylHIMDS8RBVfw00VwZTGtAR');
